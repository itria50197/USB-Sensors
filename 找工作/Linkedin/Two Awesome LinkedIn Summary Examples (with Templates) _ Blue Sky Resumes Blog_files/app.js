...
$(function() {
  ...
  if ($('.comments-block').length > 0) {
    var $commentsBlockHeight = $('.comments-block').outerHeight();
    $('.comments').css('height', $commentsBlockHeight + "px");
  }

  if ($('#body-pos').length > 0) {
    var $bodyPos = $("#body-pos").offset().top;
    var $sliderPos = $bodyPos

    $('.sliders-wrap').css('top', $bodyPos + "px");

    $('.sliders').scrollToFixed({
      limit: $('#author-box').offset().top - $('.sliders').outerHeight() - 10,
      zIndex: 990,
      removeOffsets: true,
      marginTop: 100
      // preFixed: function(el) { $('.wrap-outer-sub-nav').css('background', "url(http://www.rivercity.org/wp-content/themes/rivercity/assets/images/bg-sub-nav.png) no-repeat"); },
      // postFixed: function(el) { $('.wrap-outer-sub-nav').css('background', ''); },
    });
  }
  ...
  // var $bodyPos = $("#body-pos").offset().top;
  // if ($(".mediaq").css("position") == "relative" ){
  //   $('.sliders').css('top', $bodyPos + "px");
  // }
  ...
  //     //var $cta = $("#cta-main").offset().top;

  //     if ($(".mediaq").css("position") == "relative" ){
  //       //$('.sliders').css('top', $bodyPos + "px");

  //       if ($bodyPos < $windowTop) {
  //         $('.sliders').css({
  //           'position': 'fixed',
  //           'right': '25px',
  //           'top': '35px'
  ...
  // if(wHeight > 480) {
  //   $('.hero-landing').css('height', wHeight);
  //   $('.hero-content').css('height', wHeight-184);
